...
var encodedData  = require('soop').load('kumacore/util/EncodedData',{
  base58: base58
});
var versionedData= require('soop').load('kumacore/util/VersionedData',{
  parent: encodedData
});
var Address = require('soop').load('kumacore/lib/Address',{
